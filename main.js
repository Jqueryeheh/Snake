...
class Game
{
  constructor(score = 0, start = false, isEat = true, apple_colors = ["#FF0000", "#00FF1D", "#00FFF3", "#93FF00", "#0100FF", "#FF6E00", "#FF0095", "#00FF9F", "#8B00FF", "#FFFFFF"], sounds = ['res/Snake Game - Theme Song.mp3','res/food.mp3','res/zapsplat_multimedia_game_sound_try_again_tone_classic_arcade_style_86028.mp3'], game_over = false, playing = false) {
    this.score = score;
    this.start = start;
    this.isEat = isEat;
